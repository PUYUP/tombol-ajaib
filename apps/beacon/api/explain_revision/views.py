...
# SERIALIZERS
from .serializers import ExplainRevisionSerializer
...
class ExplainRevisionApiView(viewsets.ViewSet):
    ...
    def create(self, request, format=None):
        ...
        serializer = ExplainRevisionSerializer(data=request.data, context=context)
    ...
    def partial_update(self, request, uuid=None):
        ...
        try:
            queryset = ExplainRevision.objects.get(uuid=uuid)
        except ObjectDoesNotExist:
            raise NotFound()

        serializer = ExplainRevisionSerializer(
            instance=queryset,
            data=request.data,
            context=context,
            partial=True)
    ...
    def destroy(self, request, uuid=None):
        ...
        queryset = ExplainRevision.objects.filter(uuid=uuid, creator=person)
